...
reconciliation: two-kind record channel, keyword relevance, accept-only
dependency data).

The channel separates exact-value annotations from keyword dependency
information (DESIGN.md §4; ADR 0002), and evaluation applies draft-03 §12.2
relevance: non-verbose output omits the errors of an accepting keyword's
rejecting sub-evaluations and the annotations under a rejecting schema
object, modern verbose output marks them (`droppedErrors`,
`droppedAnnotations`), and the 2020-12 Verbose document is unchanged. The
output-level controls (ADR 0003) are not yet modeled; the table below
describes current code. The output-control work and public release sequence
are tracked in [docs/planning/next-steps](docs/planning/next-steps/README.md).

## Built and gated

| Area                              | State                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Interpreter (`@jse/core`)         | Complete for draft 2020-12, 2019-09, draft-07, draft-06: evaluation, a two-kind record channel (annotations carry the keyword's own value; applicator keywords produce dependency data that never reaches output, and only when they accept), draft-03 §12.2 relevance (an accepting keyword's rejecting sub-evaluations lose their errors; `if`/`then`/`else` are separate keyword results with `if`'s outcome as dependency data), all output structures/vocabularies, `$dynamicRef`/`$recursiveRef`, `$vocabulary` dialects, loaders, source positions, security bounds.                                                                                                                                                                                                                                                                                                                                                                                                   |
