...
Last updated: 2026-09-05 (post-M9a plus the IETF draft-03 semantic
reconciliation and the output model: two-kind record channel, keyword
relevance, accept-only dependency data, formats by name with levels and
orthogonal controls).
...
([guide](docs/guide/output-formats.md)). The compiled tier renders the flat
surface and the Basic document; its structured documents and the public
...
| Trace + schema-walk surface       | Stable (promoted from `@alpha` at the M9a publication-readiness pass): `trace: true` on any non-flag output renders the evaluation trace (`Result.trace`, `TraceUnit`); `walkSchema` walks schema positions by dialect keyword facts. Interpreter/rendering only — the compiled tier emits no trace (M8.6).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
