// Official-suite conformance for @json-schema-engine/compiler's compiled tier (M6.4). Same
// FILES list and remotes loader as @json-schema-engine/core's suite.test.ts (M3): every
