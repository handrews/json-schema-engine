...
if ((g5 && ("displayName" in v))) { const m6 = st.anns.length; if (!u2(v["displayName"], d, h_s0, ep + "/properties/displayName", ip + "/displayName", st, tn)) { ok = false; k0 = false; h_cutA(st, m6); } }
if ((g5 && ("bio" in v))) { const m7 = st.anns.length; if (!u3(v["bio"], d, h_s0, ep + "/properties/bio", ip + "/bio", st, tn)) { ok = false; k0 = false; h_cutA(st, m7); } }
if ((g5 && ("createdAt" in v))) { const m8 = st.anns.length; if (!u4(v["createdAt"], d, h_s0, ep + "/properties/createdAt", ip + "/createdAt", st, tn)) { ok = false; k0 = false; h_cutA(st, m8); } }
if (g5) {  }
...
if (g5) { if (!(("id" in v))) { ok = false; k2 = false; h_err(st, tn, { evaluationPath: ep + "/required", schemaLocation: "https://spike.example/profile#/required", inputLocation: ip, error: "missing required property 'id'", keyword: "required", vocabulary: "https://json-schema.org/draft/2020-12/vocab/validation", params: { "missingProperty": "id" } }); } }
