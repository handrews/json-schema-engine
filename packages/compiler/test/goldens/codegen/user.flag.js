...
if ((g1 && ("name" in v))) { const t2 = v["name"];
...
if ((g1 && ("address" in v))) { const t7 = v["address"];
const g9 = (typeof t7 === "object" && t7 !== null && !Array.isArray(t7));
if ((g9 && ("street" in t7))) { const t8 = t7["street"];
if (!((typeof t8 === "string"))) { return false; } }
if ((g9 && ("city" in t7))) { const t10 = t7["city"];
if (!((typeof t10 === "string"))) { return false; } }
if ((g9 && ("zip" in t7))) { const t11 = t7["zip"];
