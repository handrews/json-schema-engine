...
if ((g0 && (v["displayName"] !== undefined))) { if (!u2(v["displayName"], d, h_s0, ep + "/properties/displayName", ip + "/displayName", errs)) { ok = false; } }
if ((g0 && (v["bio"] !== undefined))) { if (!u3(v["bio"], d, h_s0, ep + "/properties/bio", ip + "/bio", errs)) { ok = false; } }
if ((g0 && (v["createdAt"] !== undefined))) { if (!u4(v["createdAt"], d, h_s0, ep + "/properties/createdAt", ip + "/createdAt", errs)) { ok = false; } }
if (g0) {  }
...
if (g0) { if (!((v["id"] !== undefined))) { ok = false; errs.push({ evaluationPath: ep + "/required", schemaLocation: "https://spike.example/profile#/required", inputLocation: ip, error: "missing required property 'id'", keyword: "required", vocabulary: "https://json-schema.org/draft/2020-12/vocab/validation", params: { "missingProperty": "id" } }); } }
